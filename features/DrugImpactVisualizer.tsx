            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                {activeTab === 'disease' ? (
                    ...
                    <div className="flex flex-1 overflow-hidden relative">
                        ...
                        <div className={`w-full md:w-[320px] md:min-w-[320px] md:max-w-[320px] flex-shrink-0 flex-col border-r border-white/10 bg-slate-950/20 backdrop-blur-sm overflow-y-auto no-print ${mobileViewTab === 'controls' ? 'flex' : 'hidden md:flex'}`}>
                        ...
                        {/* CENTER — 3D Body View */}
                        <div className={`flex-1 min-w-0 relative overflow-hidden bg-gradient-to-b from-black via-slate-950/60 to-black ${mobileViewTab === 'model' ? 'flex flex-col' : 'hidden md:flex md:flex-col'}`}>
                        ...
                        <div className={`w-full md:w-[384px] md:min-w-[384px] md:max-w-[384px] flex-shrink-0 border-l border-white/10 bg-slate-950/20 backdrop-blur-sm overflow-hidden flex-col ${mobileViewTab === 'results' ? 'flex' : 'hidden md:flex'}`}>
                            {/* Mode Tab Switcher */}
                    ...
                    <div className="flex flex-1 overflow-hidden relative">
                        ...
                        <div className={`w-full md:w-96 flex-shrink-0 border-l border-white/10 bg-slate-950/20 backdrop-blur-sm overflow-hidden flex-col ${mobileViewTab === 'results' ? 'flex' : 'hidden md:flex'}`}>
                            {/* Tab selector */}
                            <div className="flex-shrink-0 p-4 border-b border-white/10 bg-white/[0.02]">
                                <div className="flex bg-black/60 rounded-2xl p-1.5 border border-white/10 shadow-2xl">
                                    <button
