            ...
            <header className="fixed top-0 left-0 right-0 z-40 transition-all duration-300">
                ...
                <div className="container mx-auto px-3 sm:px-4 py-2 sm:py-2.5 relative flex justify-between items-center max-w-7xl">
                    ...
                    <div className="flex items-center space-x-1 sm:space-x-2 md:space-x-3 flex-shrink-0">
                        ...
                        <div className="h-4 sm:h-5 w-px bg-white/10 hidden md:block"></div>
                        <ThemeToggleButton />
                        <ProfileMenu />
                    </div>
                </div>
                ...
                <>
                    ...
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-gradient-to-tr from-teal-600 via-cyan-600 to-blue-600 text-white p-3 sm:p-3.5 md:p-4 rounded-2xl shadow-2xl hover:shadow-teal-500/50 transform hover:scale-105 transition-all duration-300 ring-1 ring-white/30">
                                {ICONS.chatbot}
                            </div>
                        </div>
                    </button>
